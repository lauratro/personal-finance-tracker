...
export class InvestmentUpdateMapper {
  static mapInvestment(
    ...
    dto: UpdateInvestmentHistoryDto,
    ...
    if (dto.boughtDate !== undefined)
      updatedData.boughtDate = new Date(dto.boughtDate);
    if (dto.totalAmountInvested !== undefined) {
      updatedData.totalAmountInvested = new Prisma.Decimal(
        dto.totalAmountInvested,
      );
    }
    ...
    if (dto.plannedPriceToSell !== undefined) {
      updatedData.plannedPriceToSell = new Prisma.Decimal(
        dto.plannedPriceToSell,
      );
    }
