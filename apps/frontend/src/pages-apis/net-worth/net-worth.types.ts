...
export type NetWorthSnapshotWithTotal = NetWorthSnapshot & {
  total: number;
};

export type NetWorthIndicators = {
  lastSnapshot:NetWorthSnapshotWithTotal  | null;
  previousSnapshot: NetWorthSnapshotWithTotal | null;
};
